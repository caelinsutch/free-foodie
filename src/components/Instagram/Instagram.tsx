    ...
    >
      <HStack spacing={{ base: "1rem", sm: "2rem" }}>
        ...
        >
          <Link href={info[0][1]}>
            <IGCard>
              <GatsbyImage image={info[0][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
          <Link href={info[1][1]}>
            <IGCard>
              <GatsbyImage image={info[1][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
          <Link href={info[2][1]}>
            <IGCard>
              <GatsbyImage image={info[2][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
        </VStack>
        <VStack spacing={{ base: "1rem", sm: "2rem" }}>
          <Link href={info[3][1]}>
            <IGCard>
              <GatsbyImage image={info[3][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
          <IGTitle />
          <Link href={info[4][1]}>
            <IGCard>
              <GatsbyImage image={info[4][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
        </VStack>
        <VStack
        ...
        >
          <Link href={info[5][1]}>
            <IGCard>
              <GatsbyImage image={info[5][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
          <Link href={info[6][1]}>
            <IGCard>
              <GatsbyImage image={info[6][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
          <Link href={info[7][1]}>
            <IGCard>
              <GatsbyImage image={info[7][0]} alt="Instagram Post" />
            </IGCard>
          </Link>
        </VStack>
      </HStack>
